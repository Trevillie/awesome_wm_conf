...
--        max_clients = 1,
        position    = 2,
        spawn    = "/opt/google/chrome/chrome --new-window",
    },
    WRT_3 = {
        ...
        exclusive = false,
        position  = 3,
        spawn     = "/opt/google/chrome/chrome --app-id=kidnkfckhbdkfgbicccmdggmpgogehop",
--        slave     = true,
    },
    COM_4 = {
        layout    = awful.layout.suit.tile.right,
        spawn    = "/opt/google/chrome/chrome --new-window https://web.wechat.com/ mail.google.com mail.163.com mail.shanghaitech.edu.cn https://news.ycombinator.com/",
        mwfact    = 0.30,
        exclusive = false,
        position  = 4,
    },
    MIS_5 = {
        layout   = awful.layout.suit.tile,
        spawn    = "/opt/google/chrome/chrome --new-window https://calendar.google.com/",
        position = 5,
    },
}
